...
$sql = "INSERT INTO member (hoten,username, password,ngsinh, email, phone) VALUES ('$hoten','$username','$password','$ngsinh','$email','$phone')";
echo '<script language="javascript">alert("Đăng ký thành công!"); window.location="nhapthongtin.php";</script>';
...
echo '<script language="javascript">alert("Có lỗi trong quá trình xử lý"); window.location="nhapthongtin.php";</script>';
}
}
}
?>
