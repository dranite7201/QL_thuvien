        ...
        <tbody>
            ...
            <?php foreach ($book as $i => $sach) { ?>
                <div style="text-align: center;">
                    ...
                    <div>Tên sách: <?php echo $sach['title'] ?></div>
                    <div>Tác giả: <?php echo $sach['author_name'] ?></div>
                    <div>Thể Loại: <?php echo $sach['category'] ?></div>
                    <div>Số Trang: <?php echo $sach['pagec'] ?><div>
